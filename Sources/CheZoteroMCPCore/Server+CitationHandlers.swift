...
extension CheZoteroMCPServer {
    ...
    func handleToBiblatexAPA(_ params: CallTool.Parameters) throws -> CallTool.Result {
        ...
        let header = "% Generated by che-zotero-mcp — biblatex-apa format\n% Compatible with: \\usepackage[style=apa,backend=biber]{biblatex}\n% Items: \(items.count)\n% NOTE: Acronyms and abbreviations in titles are auto-protected with {braces}.\n%   Single-word proper nouns (country names, person names, etc.) may need\n%   manual brace protection — biblatex-apa lowercases unbraced English titles.\n"
